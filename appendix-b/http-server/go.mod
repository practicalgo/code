module github.com/practicalgo/code/appendix-b/http-server
...
require (
	...
	github.com/practicalgo/code/appendix-b/grpc-server/service v0.0.0
...
replace github.com/practicalgo/code/appendix-b/grpc-server/service => ../grpc-server/service
