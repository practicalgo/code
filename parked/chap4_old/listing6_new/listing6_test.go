...
func TestHandlers(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "index", path: "/", expectedResponse: "Hello, world!", expectedRequestLog: "method=GET path=/ status=200"},
		...
		{name: "healthcheck", path: "/healthcheck", expectedResponse: "ok", expectedRequestLog: "method=GET path=/healthcheck status=200"},
		{name: "deepcheck", path: "/deepcheck", expectedResponse: "deepcheck_ok", expectedRequestLog: "method=GET path=/deepcheck status=200"},
	}
