...
import (
	...
	"github.com/practicalgolang/code/chap2/listing15/middleware"
	"github.com/practicalgolang/code/chap2/listing15/types"
)
...
func SetupHandlers(mux *chi.Mux, logger *log.Logger) http.Handler {
	...
	return middleware.LogRequestsMiddleware(
		logger,
