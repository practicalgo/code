...
func TestServer(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "GET /api", path: "/api/package/mypackage", method: "GET", expectedResponse: "Package details for: mypackage", expectedResponseCode: 200},
		{name: "GET /api", path: "/api/package/mypackage/1.0.0", method: "GET", expectedResponse: "Package details for: mypackage Version: 1.0.0", expectedResponseCode: 200},
	}
